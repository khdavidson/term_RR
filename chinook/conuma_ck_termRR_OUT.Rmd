...
```{r studyarea-fig, fig.cap='Conuma run reconstruction study area.'}
knitr::include_graphics(here::here("data", "gitData", "statarea25_maponly.png"))
```
...
```{r}
catConFull$MONTH <- factor(catConFull$MONTH, levels=c("May","June","July","August","September","October", ordered=T))
```
